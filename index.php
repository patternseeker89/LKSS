...
$storage->insertNode(8, 6, 'test data 7');

$storage->insertNode(9, 6, 'test data 7');

$storage->insertNode(10, 9, 'test data 7');

$storage->insertNode(11, 2, 'test data 7');

$storage->insertNode(12, 2, 'test data 7');
